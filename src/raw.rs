...
pub type __io_read_fn = extern "C" fn(__cookie: *mut ::libc::c_void,
                                      __buf: *mut ::libc::c_char,
                                      __nbytes: size_t)
                                      -> __ssize_t;
pub type __io_write_fn = extern "C" fn(__cookie: *mut ::libc::c_void,
                                       __buf: *const ::libc::c_char,
                                       __n: size_t)
                                       -> __ssize_t;
pub type __io_seek_fn = extern "C" fn(__cookie: *mut ::libc::c_void,
                                      __pos: *mut __off64_t,
                                      __w: ::libc::c_int)
                                      -> ::libc::c_int;
pub type __io_close_fn = extern "C" fn(__cookie: *mut ::libc::c_void) -> ::libc::c_int;
...
impl ::std::default::Default for Struct_pcap_addr {
    fn default() -> Struct_pcap_addr {
        unsafe { ::std::mem::zeroed() }
    }
}
pub type pcap_handler = ::std::option::Option<extern "C" fn(arg1: *mut u_char,
...
impl ::std::default::Default for Struct___va_list_tag {
    fn default() -> Struct___va_list_tag {
        unsafe { ::std::mem::zeroed() }
    }
}
...
extern "C" {
    ...
    pub fn pcap_open_dead_with_tstamp_precision(arg1: ::libc::c_int,
                                                ...
                                                arg3: u_int)
                                                -> *mut pcap_t;
    pub fn pcap_open_offline_with_tstamp_precision(arg1: *const ::libc::c_char,
                                                   arg2: u_int,
    ...
    //  -> *const u_char;
    pub fn pcap_next_ex(arg1: *mut pcap_t,
                        arg2: *mut *mut Struct_pcap_pkthdr,
                        arg3: *mut *const u_char)
                        -> ::libc::c_int;
    // pub fn pcap_breakloop(arg1: *mut pcap_t) -> ();
    pub fn pcap_stats(arg1: *mut pcap_t, arg2: *mut Struct_pcap_stat) -> ::libc::c_int;
    pub fn pcap_setfilter(arg1: *mut pcap_t, arg2: *mut Struct_bpf_program) -> ::libc::c_int;
    ...
    pub fn pcap_sendpacket(arg1: *mut pcap_t,
                           arg2: *const u_char,
                           arg3: ::libc::c_int)
                           -> ::libc::c_int;
    ...
    pub fn pcap_compile(arg1: *mut pcap_t,
                        arg2: *mut Struct_bpf_program,
    ...
    pub fn pcap_dump(arg1: *mut u_char,
                     arg2: *const Struct_pcap_pkthdr,
                     arg3: *const u_char)
                     -> ();
...
#[link(name = "pcap")]
extern "C" {
    pub fn pcap_inject(arg1: *mut pcap_t,
